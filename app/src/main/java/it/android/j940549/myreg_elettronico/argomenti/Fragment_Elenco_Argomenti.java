 ...
 * {@link Fragment_Elenco_Argomenti.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Fragment_Elenco_Argomenti#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Fragment_Elenco_Argomenti extends Fragment {
    ...
    ArrayList results = new ArrayList<DataObject_Argomenti>();
    String TAG_LOG="Fragment_elenco_argomenti";

//    private OnFragmentInteractionListener mListener;

    public Fragment_Elenco_Argomenti() {
    ...
    public static Fragment_Elenco_Argomenti newInstance( String cod_alunno, String annosc, String quadr) {
        Fragment_Elenco_Argomenti fragment = new Fragment_Elenco_Argomenti();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_fragment__elenco__argomenti, container, false);

        mRecyclerView = (RecyclerView) rootView.findViewById(R.id.my_recycler_view_elenco_argomenti);
        mRecyclerView.setHasFixedSize(true);
        mLayoutManager = new LinearLayoutManager(getContext());
        mRecyclerView.setLayoutManager(mLayoutManager);

        mAdapter = new MyRecyclerViewAdapter_ElencoArgomenti(results);
...
/*        if (context instanceof OnFragmentInteractionListener) {
  ...
  */  }
    ...
    private ArrayList<DataObject_Argomenti> getDataSet() {
        return results;
    }
    ...
    public void caricaDati(String alunno,String annosc,String quadrimestre) {
        ...
        try {
            ...
            dbLayer.open();
            Cursor cursor = dbLayer.getRichesta_argomenti(alunno,annosc);
...
//                    "alunno TEXT, annosc TEXT,  data INTEGER, argomento TEXT, compiti TEXT, assenze TEXT, noteprof  TEXT,notediscip  TEXT );");
                    ...
                    DataObject_Argomenti obj = new DataObject_Argomenti(a,b,c );
